      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image:url('https://www.zohowebstatic.com/sites/default/files/styles/product-home-page/public/zoho-logo.png');background-size:contain"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Lead partner!</h1>
                  </div>
                  <form class="user needs-validation" novalidate action="{{route('admin-login')}}" method="POST">
                    @csrf
                    <input type="hidden" name="type" value="zoho">
