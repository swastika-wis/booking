            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form  class="user needs-validation" novalidate action="/login" method="POST">
                      ...
                      <!--div class="form-group">
                        <input type="password" class="form-control form-control-user" id="userpasswd" placeholder="Password">
                      </div/-->
                      <div class="form-group">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="/?semid=<?php echo $semid;?>&vendor=<?php echo $vendor;?>">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
